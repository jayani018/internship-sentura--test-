...
declare const Editor: ({ id, appId, parentId, placeholder, text, buttonText, embed, attachments: initialAttachments, options: initialOptions, meeting: initialMeeting, showAttachments, showCloudFiles, showEmbeds, showPolls, showMeetings, showTyping, useDraft, showMention, onSubmit, editorType, editorLocation }: Props) => React.JSX.Element;
